 ...
 *
 * It is easy to identify which operations are intermediate and which are terminal. All intermediate
  ...
  public static void main(String[] args) {
     ...
     */
        gamesList.stream()
            .map((i)->i.getTitle())
            .sorted()
            .forEach(gameString -> System.out.println("Game String title is " + gameString + (gameString instanceof String)));
