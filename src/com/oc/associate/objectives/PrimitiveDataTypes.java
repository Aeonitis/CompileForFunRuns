...
public class PrimitiveDataTypes {
    ...
    double hexedDouble = 0xB1_0000;         // 0x implies interpretation as Hexadecimal digits and 'B' is a valid Hexadecimal digit i.e. 0 to F.
    ...
    float binaryFloat = 0B10_000;           // Floating-point literal suffix f/F is not valid with binary/hex values. Binary value, an explicit cast is not required since 10,000 can fit into a float i.e. 5 out of 32 bits, otherwise it won't compile.
